...
public class SalesOrderView {
        ...
        public interface All extends Id, CustomerPONumber, Quantity, Amount, CustomerRequestedDate, TrwConfirmedDate,
        ...
        public interface AllAndCustomerAllAndSalesOrderTypeAllAndSalesOrderItemAllAndCustomerItemAll
                        extends AllAndCustomerAllAndSalesOrderTypeAllAndSalesOrderItemAll,
                        SalesOrderItemView.AllAndCustomerItem {
        }
        ...
        public interface AllAndDispatchScheduleAndLoadingPlanItemAndLoadingPlanAndDispatchNoteAndinvoice
                        extends All, AllAndLoadingPlanItem, AllAndItemAll, AllAndPaintAll, AllAndInvoice,
                        AllAndLoadingPlan, AllAndDispatchNote {
        }
