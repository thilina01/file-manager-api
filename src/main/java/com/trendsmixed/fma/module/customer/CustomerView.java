...
public class CustomerView {
        ...
        public interface All extends Id, Code, Name, ShortName, Consignee, Contact, Continent, Fax, FinalDestination,
                        Note, SpecialRequirements, OfficeAddress, PhoneNo, SVatNo, VatNo, PageView.All {
        }
        ...
        public interface AllAndCustomerItemListAndItemAll
                        extends All, CustomerItemList, CustomerItemView.AllAndItemAll {
        }

        public interface AllAndIncotermAllAndCustomerTypeAllAndCurrencyAllAndCustomerItemList
                        extends All, Incoterm, IncotermView.All, CustomerType, CustomerTypeView.All, Currency,
                        CurrencyView.All, AllAndCustomerItemList {
        }

        public interface AllAndIncotermAllAndCustomerTypeAllAndCurrencyAllAndCustomerItemListAndItemAll
                        extends All, Incoterm, IncotermView.All, CustomerType, CustomerTypeView.All, Currency,
                        CurrencyView.All, AllAndCustomerItemListAndItemAll {
        }

        public interface AllAndIncotermAllAndCustomerTypeAllAndCurrencyAll extends All, Incoterm, IncotermView.All,
                        CustomerType, CustomerTypeView.All, Currency, CurrencyView.All {
        }

        public interface AllAndIncotermAllAndCustomerTypeAllAndCurrencyAllAndNotifyPartyAllAndContactAllAndContactTypeAllAndPaymentTermAllAndAddressAllAndAddressTypeAllAndCountryAllAndPortAll
