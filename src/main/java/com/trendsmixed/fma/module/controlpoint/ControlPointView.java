...
public class ControlPointView {
	...
	public static interface AllAndWorkCenterAllAndCostCenterAllAndSectionAll
			extends All, WorkCenter, WorkCenterView.AllAndCostCenterAll, CostCenterView.AllAndSectionAll {
