...
import com.trendsmixed.fma.service.FileTypeService;
...
public class FileTypeController {
    ...
    @PostMapping
    public FileType save(@RequestBody FileType fileType, @RequestHeader(value = "email", defaultValue = "") String email) {
